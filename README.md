...
1. Open the [latest Release](https://github.com/williamdh457/codex-spur/releases/latest) and download  
   `Codex.Spur_0.1.10_aarch64.dmg` (GitHub may normalize spaces in the asset name)
...
gh release create v0.1.10 \
  "src-tauri/target/release/bundle/dmg/Codex Spur_0.1.10_aarch64.dmg" \
  --title "Codex Spur 0.1.10" \
